...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dlint-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14474&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dlint-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dlint` can be installed with:

```
conda install dlint
```

It is possible to list all of the versions of `dlint` available on your platform with:
